 ...
 * `oh-my-pi/packages/coding-agent/src/session/shake-types.ts`, verified against stock 18.0.8 and re-checked against 18.2.0, with the file unchanged at that audit) so the
