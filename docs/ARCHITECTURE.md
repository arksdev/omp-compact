...
- **What is verified where.** Critical tool / read-group / transcript / TUI
  shapes: written against 17.3.1 and re-verified on the current pin 18.0.11.
  ...
  the 18.0.11 gate). On 17.2.12 the same cache shows TTSR / todo-reminder /
...
- **What 18.0.1 changed in the transcript.** The container replaced its
  ...
  through 18.0.11 left the whole critical surface untouched — the container
