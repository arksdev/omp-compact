...
Это расширенное руководство по установке, режимам, настройкам, evidence model, replay и сопровождению `omp-compact`. Краткий обзор для страницы репозитория находится в [`README.md`](../README.md).
