 ...
 *
 * Usage:
 *   bun run replay/extract.ts --list          # print run summaries for the corpus
 *   bun run replay/extract.ts                 # regenerate replay/fixtures/*.json
 *   OMP_SESSIONS_DIR=/path bun run replay/extract.ts
 */
