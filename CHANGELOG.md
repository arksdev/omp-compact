...
- Переменная окружения `OMP_COMPACT_TRACE=1` объясняет, почему карточка инструмента осталась в родной рамке. Рамка внутри компактной сессии всегда означает одно: плагин не смог доказать, какому вызову принадлежит эта карточка, — а в записи сессии такое решение не сохраняется. Теперь каждая такая развязка печатает одну строку в stderr: сколько несвязанных карточек против скольких запущенных вызовов, что осталось родным после перестройки протокола, и на каком именно обратном вызове возникла неоднозначность идентификатора. По умолчанию выключено, и пока выключено — строка даже не собирается.

### Исправлено

- Чтение файла или ссылки рядом с другим инструментом в одном сообщении больше не уводит обе карточки в родную рамку. Форму карточки для `read` выбирает сам OMP — сгруппированная строка или отдельная карточка, — и решает он это по своему снимку аргументов и по своему списку схем, который плагину недоступен. Плагин раньше повторял это решение догадкой: если догадка расходилась с выбором хоста, строки инструментов сопоставлялись с чужими карточками, и рамка оставалась до конца прогона. Теперь плагин наблюдает решение хоста и подстраивается под него.
