...
- Восстановлена загрузка плагина в скомпилированном OMP 18.2.5 после переноса UI-модулей в `pi-tui`. Импорты keybindings и типов темы используют стабильный корневой экспорт; два недоступных внутренних helper сохранены локально с регрессионными тестами. Development host обновлён до 18.2.5. Карточки навыков и поздней диагностики с закрытыми полями остаются штатными.
