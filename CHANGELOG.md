...
- Чтения больше не привязываются к чужой группе после пересборки истории. Раньше, если между группами оставалось чтение, чью группу не удалось распознать, соседняя группа могла забрать его сегмент: строка чтения рисовалась в чужой карточке, а настоящая группа оставалась в нативном виде. Теперь, когда порядок сопоставления невозможно доказать, сомнительные группы остаются нативными — строка чтения не появляется там, где ей не место.
